...
class HomeMultiTwoOptionContainer extends StatefulWidget {
  ...
  HomeMultiTwoOptionContainer(
      ...
      this.multipleData});
  @override
  _HomeMultiTwoOptionContainerState createState() =>
      _HomeMultiTwoOptionContainerState();
}

class _HomeMultiTwoOptionContainerState
    extends State<HomeMultiTwoOptionContainer> {
  bool open = false;
  bool v3 = false;
