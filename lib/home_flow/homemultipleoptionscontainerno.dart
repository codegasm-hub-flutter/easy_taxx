...
class HomeMultipleOptionsContainerNo extends StatefulWidget {
  ...
  HomeMultipleOptionsContainerNo(
      {this.identity,
      this.bigQuestion,
      ...
      this.multipleData});
  @override
  _HomeMultipleOptionsContainerNoState createState() =>
      _HomeMultipleOptionsContainerNoState();
}

class _HomeMultipleOptionsContainerNoState
    extends State<HomeMultipleOptionsContainerNo> {
  bool open = false;
  bool v3 = false;
  String noOption = "";
...
//Home
    ...
    qu.HomeAddAnswer(widget.identity, widget.bigQuestion,
