                    ...
                    onDismissed: (DismissDirection direction) {
                      ...
                      Navigator.push(context,
                        ...
                        return UnSupportedScreen(
                            ...
                            textTitle:
                                "Letting, leasing, and sales of multiple properties",
                            textMessage:
                                "Being a landlord you probably know that tax declarations are very tricky in your situation.Please be patient while we figure out a simple solution for you.");
                      }));
                    },
                    child: Container(
                      height: 170,
                    ...
                    onTap: () {
                      if (!(noOption == "No" ||
                        ...
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) {
                          return UnSupportedScreen(
                              textImage: "images/unsupportretirement.png",
                              textTitle: "Retirement & Pensions",
                              textMessage:
                                  "You deserved your time off. We are working on an easy and stress-free solution to help you with your taxes. Give us a bit more time.");
                        }));
                      } else {
                        Confirm();
                      }
...
//                    color: Colors.wh,
  ...
  void skip() {
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      return mainQuestions(
          CheckQuestion: widget.QuestionOption, CheckAnswer: ["skip"]);
    }));
  }
  ...
  void Confirm() {
    ...
    if (data[0] == "Self-employed" || data[0] == "Own business") {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        return UnSupportedScreen(
            textImage: "images/unsupportselfemploy.png",
            textTitle: "Self-employment & Owning a business",
            textMessage:
                "Being your own boss is a great step in your career and you probably understand best that taxes are not easy with that. Please be patient while we figure out a simple solution for you!");
      }));
    } else if (data[0] == "Forestry") {
      Navigator.of(context).pop();
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        return UnSupportedScreen(
            textImage: "images/unsupportforest.png",
            textTitle: "Forester & Farmer",
            textMessage:
                "It's a nice job being out in nature instead of sitting in an office chair. Just taxes are a bit tricky with that, so please be a bit patient.");
      }));
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        return UnSupportedScreen(
            textImage: "images/unsupportletting.png",
            textTitle: "Letting, leasing, and sales of multiple properties",
            textMessage:
                "Being a landlord you probably know that tax declarations are very tricky in your situation.Please be patient while we figure out a simple solution for you.");
      }));
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        return UnSupportedScreen(
            textImage: "images/adultrelative.png",
            textTitle: "Support of adult relatives",
            textMessage:
                "We admire that you support your relatives and we would really like to help you with your taxes.Please be a bit patient");
      }));
    } else if (data[0] == "Private loan" ||
        data[0] == "Partiarisches Darlehen") {
      Navigator.of(context).pop();
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        return UnSupportedScreen(
            textImage: "images/unsupportloan.png",
            textTitle: "Loans",
            textMessage:
                "We appreciate that you support other people and would like to help you with your taxes.Unfortunately, taxes are a bit tricky with that, so please be a bit patient.");
      }));
    } else if (data[0] == "Silent partnerships") {
      Navigator.of(context).pop();
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        return UnSupportedScreen(
            textImage: "images/unsupportsilentpartnership.png",
            textTitle:
                "Silent partnerships, Company shares, Shareholder in a company",
            textMessage:
                "Making tax declarations most profitable for you requires some more time.Please be patient while we figure out a simple solution for you!");
      }));
    } else if (data[0] == "Foreign investment funds") {
      Navigator.of(context).pop();
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        return UnSupportedScreen(
            textImage: "images/unsupportforeign.png",
            textTitle: "Foreign, bank accounts, foreign investment funds",
            textMessage:
                "Foreign bank accounts and investments are a bit tricky from a tax perspective but we are of course willing to help you with your taxes. Please be a bit patient!");
      }));
    } else if (data[0] == "skip") {
      Navigator.of(context).pop();
      Navigator.push(context, MaterialPageRoute(builder: (context) {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        return mainQuestions(
            CheckQuestion: widget.QuestionOption, CheckAnswer: data);
      }));
    }
