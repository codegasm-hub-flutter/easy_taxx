...
class EducationMultiTwoContainer extends StatefulWidget {
  ...
  EducationMultiTwoContainer(
      ...
      this.multipleData});
  @override
  _EducationMultiTwoContainerState createState() =>
      _EducationMultiTwoContainerState();
}

class _EducationMultiTwoContainerState
    extends State<EducationMultiTwoContainer> {
  bool open = false;
  bool v3 = false;
