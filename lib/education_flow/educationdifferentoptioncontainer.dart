...
class EducationDifferentOptionContainer extends StatefulWidget {
  ...
  EducationDifferentOptionContainer(
      {this.identity,
      this.bigQuestion,
      this.briefqstn,
      ...
      this.multipleData});
  @override
  _EducationDifferentOptionContainerState createState() =>
      _EducationDifferentOptionContainerState();
}

class _EducationDifferentOptionContainerState
    extends State<EducationDifferentOptionContainer> {
  bool open = false;
  bool v3 = false;
