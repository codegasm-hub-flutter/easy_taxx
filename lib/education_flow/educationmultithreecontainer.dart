...
class EducationMultiThreeContainer extends StatefulWidget {
  ...
  EducationMultiThreeContainer(
      ...
      this.multipleData});
  @override
  _EducationMultiThreeContainerState createState() =>
      _EducationMultiThreeContainerState();
}

class _EducationMultiThreeContainerState
    extends State<EducationMultiThreeContainer> {
  bool open = false;
  bool v3 = false;
...
//                    color: Colors.wh,
  ...
  void Confirm() {
    ...
    if (widget.completeQuestion ==
        ...
        widget.questionOption == "Free meals" &&
        data[0] == "No" &&
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        ...
        widget.questionOption == "Absence" &&
        (data[0] == "24 hours due to overnight stay" || data[0] == "No")) {
      Questions.unpaidInternLength += 1;
      Questions.unpaidInternText =
          "UNPAID INTERNSHIP " + Questions.unpaidInternLength.toString();
      qu.EducationAddAnswer(widget.identity, widget.bigQuestion,
