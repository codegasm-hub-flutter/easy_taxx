...
class EducationMultipleOptionsContainer extends StatefulWidget {
  ...
  EducationMultipleOptionsContainer(
      {this.identity,
      this.briefqstn,
      this.bigQuestion,
      ...
      this.multipleData});
  @override
  _EducationMultipleOptionsContainerState createState() =>
      _EducationMultipleOptionsContainerState();
}

class _EducationMultipleOptionsContainerState
    extends State<EducationMultipleOptionsContainer> {
  bool open = false;
  bool v3 = false;
...
//                    color: Colors.wh,
  ...
  void Confirm() {
    ...
    if (widget.completeQuestion ==
        ...
        widget.questionOption == "Type of costs" &&
        data[0] == "None of these") {
      Questions.trainingLength += 1;
      Questions.trainingText =
          "TRAINING " + Questions.trainingLength.toString();

      qu.EducationAddAnswer(widget.identity, widget.bigQuestion,
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        ...
        widget.questionOption == "Means of transport" &&
        (data[0] == "By car" || data[0] == "Bicycle" || data[0] == "on foot")) {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        ...
        widget.questionOption == "Transportation" &&
        (data[0] == "By bike" || data[0] == "By foot")) {
      print("thek");
