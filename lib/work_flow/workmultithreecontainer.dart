...
class WorkMultiThreeContainer extends StatefulWidget {
  ...
  WorkMultiThreeContainer(
      ...
      this.suggestion});
  @override
  _WorkMultiThreeContainerState createState() =>
      _WorkMultiThreeContainerState();
}
...
//                    color: Colors.wh,
  ...
  void Confirm() {
    ...
    if (widget.completeQuestion ==
        ...
        widget.questionOption == "Absence ${Questions.workBusTripLength}" &&
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        return WorkMainQuestions(
            CheckCompleteQuestion:
                "Do any of these kind of absences apply to ${Questions.workYouIdentity} while ${Questions.workYouIdentity} on business trip no. ${Questions.workBusTripLength}?",
            CheckQuestion: "Absence ${Questions.workBusTripLength}",
            CheckAnswer: data);
      }));
    } else if (widget.completeQuestion ==
            "Have ${Questions.workYouIdentity} received any free meals? " &&
        widget.questionOption == "Complimentary meals" &&
        data[0] == "No") {
      Questions.workBusTripLength += 1;
      Questions.workBusTripText =
          "BUSINESS TRIP " + Questions.workBusTripLength.toString();
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        return WorkMainQuestions(
            CheckCompleteQuestion:
                "What costs were you reimbursed for on business trip no. ${Questions.workBusCostLength}?",
            CheckQuestion: "Reimbursement ${Questions.workBusCostLength}",
            CheckAnswer: data);
      }));
    } else {
      qu.WorkAddAnswer(widget.identity, widget.bigQuestion,
