...
class WorkMultipleOptionsContainer extends StatefulWidget {
  ...
  WorkMultipleOptionsContainer(
      ...
      this.suggestion});
  @override
  _WorkMultipleOptionsContainerState createState() =>
      _WorkMultipleOptionsContainerState();
}

class _WorkMultipleOptionsContainerState
    extends State<WorkMultipleOptionsContainer> {
  bool open = false;
  bool v3 = false;
