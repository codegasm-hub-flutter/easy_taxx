...
class FamilyMultipleOptionsContainer extends StatefulWidget {
  ...
  FamilyMultipleOptionsContainer(
      {this.identity,
      this.bigQuestion,
      ...
      this.multipleData});
  @override
  _FamilyMultipleOptionsContainerState createState() =>
      _FamilyMultipleOptionsContainerState();
}

class _FamilyMultipleOptionsContainerState
    extends State<FamilyMultipleOptionsContainer> {
  bool open = false;
  bool v3 = false;
