...
class FamilyThreeOptionContainer extends StatefulWidget {
  ...
  FamilyThreeOptionContainer(
      ...
      this.multipleData});
  @override
  _FamilyThreeOptionContainerState createState() =>
      _FamilyThreeOptionContainerState();
}

class _FamilyThreeOptionContainerState
    extends State<FamilyThreeOptionContainer> {
  bool open = false;
  bool v3 = false;
