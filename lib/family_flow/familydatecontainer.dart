...
//                    color: Colors.wh,
  ...
  void AddData() {
    if (widget.completeQuestion == "When did your child live there?" &&
        widget.questionOption == "Period living there") {
      ...
      Questions.childAddressText =
        ...
        widget.questionOption == "Period grant") {
      ...
      Questions.kindergartenText =
        ...
        widget.questionOption == "Period financial support" &&
      ...
      Questions.dayCareText =
          "DAYCARE CENTER " + Questions.aupairLength.toString();
    }
    ...
    qu.FamilyAddAnswer(
        ...
        widget.completeQuestion,
        widget.questionOption,
        [dates.text.toString().substring(6)],
        55.0);
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      return FamilyMainQuestions(
          CheckCompleteQuestion: widget.completeQuestion,
          CheckQuestion: widget.questionOption,
          CheckAnswer: [dates.text.toString().substring(6)]);
    }));
  }
}
