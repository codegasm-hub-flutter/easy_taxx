...
class FamilyDifferentOptionContainer extends StatefulWidget {
  ...
  FamilyDifferentOptionContainer(
      {this.identity,
      this.bigQuestion,
      this.briefqstn,
      ...
      this.multipleData});
  @override
  _FamilyDifferentOptionContainerState createState() =>
      _FamilyDifferentOptionContainerState();
}

class _FamilyDifferentOptionContainerState
    extends State<FamilyDifferentOptionContainer> {
  bool open = false;
  bool v3 = false;
                              ...
                              return GestureDetector(
                                  onTap: () {
                                    if (widget.answerOption[index] ==
                                      ...
                                      Questions.schoolText = "SCHOOL FEES " +
                                          Questions.schoolLength.toString();
                                      qu.FamilyAddAnswer(
                                          widget.identity,
                                          widget.bigQuestion,
                                          widget.completeQuestion,
                                      ...
                                      Navigator.push(context,
                                        ...
                                        widget.questionOption ==
                                            "Benefits office" &&
                                        widget.answerOption[index] != "Other") {
                                      Questions.childLength += 1;
                                      Questions.childText = "CHILD " +
                                          Questions.childLength.toString();
                                      qu.FamilyAddAnswer(
                                          widget.identity,
                                          widget.bigQuestion,
                                          widget.completeQuestion,
