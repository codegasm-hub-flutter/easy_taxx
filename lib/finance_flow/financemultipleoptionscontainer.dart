...
class FinanceMultipleOptionsContainer extends StatefulWidget {
  ...
  FinanceMultipleOptionsContainer(
      {this.identity,
      this.bigQuestion,
      ...
      this.suggestion});
  @override
  _FinanceMultipleOptionsContainerState createState() =>
      _FinanceMultipleOptionsContainerState();
}

class _FinanceMultipleOptionsContainerState
    extends State<FinanceMultipleOptionsContainer> {
  bool open = false;
  bool v3 = false;
