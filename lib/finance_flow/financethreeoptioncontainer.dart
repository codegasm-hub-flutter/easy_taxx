...
class FinanceThreeOptionContainer extends StatefulWidget {
  ...
  FinanceThreeOptionContainer(
      ...
      this.suggestion});
  @override
  _FinanceThreeOptionContainerState createState() =>
      _FinanceThreeOptionContainerState();
}

class _FinanceThreeOptionContainerState
    extends State<FinanceThreeOptionContainer> {
  bool open = false;
  bool v3 = false;
