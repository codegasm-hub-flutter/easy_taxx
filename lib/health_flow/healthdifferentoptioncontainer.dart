...
class HealthDifferentOptionContainer extends StatefulWidget {
  ...
  HealthDifferentOptionContainer(
      {this.identity,
      this.briefqstn,
      this.bigQuestion,
      ...
      this.suggestion});
  @override
  _HealthDifferentOptionContainerState createState() =>
      _HealthDifferentOptionContainerState();
}

class _HealthDifferentOptionContainerState
    extends State<HealthDifferentOptionContainer> {
  bool open = false;
  bool v3 = false;
