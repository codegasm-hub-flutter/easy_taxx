...
class HealthMultipleOptionsContainer extends StatefulWidget {
  ...
  HealthMultipleOptionsContainer(
      {this.identity,
      this.briefqstn,
      this.bigQuestion,
      ...
      this.suggestion});
  @override
  _HealthMultipleOptionsContainerState createState() =>
      _HealthMultipleOptionsContainerState();
}

class _HealthMultipleOptionsContainerState
    extends State<HealthMultipleOptionsContainer> {
  bool open = false;
  bool v3 = false;
...
//                    constraints: BoxConstraints(minHeight: minHeight, maxHeight: maxHeight),
        ...
        padding: EdgeInsets.only(left: 10, right: 10, top: 10.0, bottom: 0.0),
        decoration: BoxDecoration(
